...
**Repository:** https://github.com/HemantKKumar24/Swarna_Project_Medication.git
...
```powershell
git clone https://github.com/HemantKKumar24/Swarna_Project_Medication.git
Set-Location -Path .\Swarna_Project_Medication
```
